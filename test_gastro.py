    ...
    def test(self,epoch):
        ...
        for i, sample in enumerate(tbar):
            ...
            for img,lt, lp in zip(image,target, pred):
                ...
                img_tmp *= (0.445, 0.169, 0.125)
                img_tmp += (0.676, 0.411, 0.353)
                img_tmp *= 255.0
                ...
                skimage.io.imsave('/home/user/pythonwork/gat_deeplabv3/evalue/gas' + '/image' + str(i_name) + '.png', viz)
                visualizations = []
                i_name += 1
            validate_batch += 1
...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='pascal',
                        choices=['pascal', 'coco', 'cityscapes','gastro'],
    ...
    trainer.test(trainer.args.start_epoch)
