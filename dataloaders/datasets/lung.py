...
class VOCSegmentation(Dataset):
    ...
    gas_means = (0.8096, 0.8096, 0.8096)

    gas_std = (0.1451269769389286, 0.1451269769389286, 0.1451269769389286)
    def __init__(self,
                 args,
                 base_dir=Path.db_root_dir('lung'),
                 split='train',
                 ):
        """
        ...
        self._image_dir = os.path.join(self._base_dir, '2d_images')
        self._cat_dir = os.path.join(self._base_dir, '2d_masks')
