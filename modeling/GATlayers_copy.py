...
class GraphAttentionLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, dropout, alpha, concat=True):
        ...
        self.a_conv1 = nn.Conv1d(in_channels=out_features, out_channels=1, kernel_size=1)
        self.a_conv2 = nn.Conv1d(in_channels=out_features, out_channels=1, kernel_size=1)
